...
if ( ! class_exists( 'cmplz_tc_withdrawal' ) ) {
	...
	// phpcs:enable PEAR.NamingConventions.ValidClassName.StartWithCapital, PEAR.NamingConventions.ValidClassName.Invalid, WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedClassFound
		...
		/**
		 * Register the public submission endpoints for both auth states.
		 *
		 * @since 1.4.0
		 *
		 * @return void
		...
		public function process( array $input ) {
			...
			// Valid. Task 9 attaches wp_mail() to this action; Task 7 sends nothing.
			$data = array(
				'fields'       => $clean,
				'submitted_at' => time(),
			...
			$token = $this->store_state( array( 'status' => 'success' ) );
